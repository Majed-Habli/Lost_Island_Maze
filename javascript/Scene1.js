class Scene1 extends Phaser.Scene{
    ...
    preload(){
        ...
        this.load.image("bushOne", "./../website_images/level5Images/level5Images/bushOne.png");
        this.load.image("tree4", "./../website_images/level5Images/level5Images/TreeFour.png");
        this.load.image("level5Back", "./../website_images/level5Images/level5Images/backgroundLevel5.png");
        this.load.image("bushTwo", "./../website_images/level5Images/level5Images/bushTwo.png");
        this.load.image("bush", "./../website_images/level5Images/level5Images/bushh.png");

        this.load.audio("lvl6Audio", "../underground/marioUnderground.mp3");
        this.load.audio("lvl1Audio", "/level1/LegendOfZelda.mp3");
        // this.load.audio("lvl5Audio", "./../")
    }
