class Scene1 extends Phaser.Scene {
    ...
    preload(){
        ...
        this.load.image("tree2", "./../website_images/level5Images/TreeTwo.png");
        this.load.image("tree3", "./../website_images/level5Images/TreeThree.png");
        this.load.image("tree4", "./../website_images/level5Images/TreeFour.png");
        this.load.image("level5Back", "./../website_images/level5Images/backgroundLevel5.png");
        this.load.image("bush", "./../website_images/level5Images/bushh.png")
        this.load.image("bushTB", "./../website_images/level5Images/bushtb.png")
        this.load.image("bushOne", "./../website_images/level5Images/bushOne.png");
        this.load.image("bushTwo", "./../website_images/level5Images/bushTwo.png");
        this.load.image("bushThree", "./../website_images/level5Images/bushThree.png");
